<?php
  ...
  function insertReading($sensor, $location, $userllc, $dht_temp, $dht_humid, $supp1) {
  ...
  function getAllReadings($limit) {
    ...
    $sql = "SELECT id, sens, loc, usex, temp, humid, sup, reading_time FROM SensorData order by reading_time desc limit " . $limit;
  ...
  function getLastReadings() {
    ...
    $sql = "SELECT id, sens, loc, usex, temp, humid, sup, reading_time FROM SensorData order by reading_time desc limit 1" ;
    if ($result = $conn->query($sql)) {
